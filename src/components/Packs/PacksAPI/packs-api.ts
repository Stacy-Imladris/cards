...
export const packsAPI = {
    ...
    updatePack(cardsPack: UpdatePackParams) {
        return instance.put<any, AxiosResponse<AdditionalPackResponse & Pick<PackResponses, 'updatedCardsPack'>>, UpdatePackParams>(`cards/pack`, cardsPack)
    },
}
